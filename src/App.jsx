      ...
      <header className="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
        <div>
          ...
          <p className="text-sm muted mt-1">
            Select an emotion, then drill down to reveal the hidden unmet needs.
            Built for self-awareness, coaching, and conflict repair.
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button variant="primary" onClick={() => downloadCSV(filtered)}>
            Export CSV
          </Button>
        </div>
      </header>
